...
angular.module('bhcmartApp').controller('FiltersCtrl', ['$scope', 'Filter', 'Modal', '$filter', 'Feature', '$mdDialog', function ($scope, Filter, Modal, $filter, Feature, $mdDialog) {
  ...
  $scope.deletefilter = function (ev, filter) {
    var confirm = $mdDialog.confirm().title('Would you like to delete Filter ' + filter.name + '?').ariaLabel('Delete filter').targetEvent(ev).ok('Please do it!').cancel('Cancel');
