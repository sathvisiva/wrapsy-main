...
(function () {
  var AffiliateController = function AffiliateController($http, $scope, $timeout, socket, Catalog, Product, $uibModal, Auth, $state, Registry) {
  ...
  angular.module('bhcmartApp').controller('AffiliateController', AffiliateController);
})();
