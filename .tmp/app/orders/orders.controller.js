...
angular.module('bhcmartApp').controller('OrdersCtrl', ['$scope', 'Order', 'Auth', 'Modal', function ($scope, Order, Auth, Modal) {
  ...
  $scope.searchOptions = [{ id: 1, option: "Order #" }, { id: 2, option: "Customer Name" }, { id: 3, option: "Status" }, { id: 3, option: "Date" }];
