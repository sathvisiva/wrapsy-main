...
angular.module('bhcmartApp').controller('RegistryController', ['$scope', '$stateParams', '$state', 'Registry', '$uibModal', 'Upload', 'Auth', 'toaster', '$timeout', '$mdDialog', function ($scope, $stateParams, $state, Registry, $uibModal, Upload, Auth, toaster, $timeout, $mdDialog) {
  ...
  $scope.removeProduct = function (event, pid) {
    var confirm = $mdDialog.confirm().title('Are you sure to delete the Product?').textContent('Product will be deleted permanently from the registry.').ariaLabel('Product deletion').targetEvent(event).ok('Yes').cancel('No');
    ...
    var modalInstance = $uibModal.open({
      ...
      resolve: {
        registry: function registry() {
          ...
          return product;
        }, registryslug: function registryslug() {
          return $scope.registry.slug;
        }
      }
    }).result.then(function (result) {
...
angular.module('bhcmartApp').controller('RegistryProductDetailCtrl', ['$scope', '$stateParams', '$state', 'Registry', '$uibModalInstance', 'registry', 'registryprod', 'Product', 'ngCart', 'Cart', 'Auth', '$uibModal', function ($scope, $stateParams, $state, Registry, $uibModalInstance, registry, registryprod, Product, ngCart, Cart, Auth, $uibModal) {
...
angular.module('bhcmartApp').controller('RegistryChipinProductDetailCtrl', ['$scope', '$stateParams', '$state', 'Registry', '$uibModalInstance', 'registry', 'registryprod', 'Product', 'Auth', 'Payment', 'registryslug', function ($scope, $stateParams, $state, Registry, $uibModalInstance, registry, registryprod, Product, Auth, Payment, registryslug) {
...
angular.module('bhcmartApp').controller('contributioncartController', ['$scope', '$stateParams', '$state', 'Payment', 'Auth', 'Registry', function ($scope, $stateParams, $state, Payment, Auth, Registry) {
...
angular.module('bhcmartApp').controller('inviteRegistryCtrl', function ($scope, $rootScope, $state, $stateParams, Registry, Auth, $location, $uibModalInstance, registry) {
