...
angular.module('bhcmartApp').controller('ManageHomePageCtrl', ['$scope', 'Home', 'Modal', 'Catalog', function ($scope, Home, Modal, Catalog) {
...
}]).controller('ManagePopularCategoriesAddCtrl', ['$scope', '$state', 'Home', '$stateParams', 'Catalog', function ($scope, $state, Home, $stateParams, Catalog) {
