...
angular.module('bhcmartApp').controller('ManageHomeCtrl', ['$scope', '$state', '$stateParams', 'Home', 'Catalog', function ($scope, $state, $stateParams, Home, Catalog) {
...
}]).controller('ManageHomePageImgAddCtrl', ['$scope', '$state', 'Home', '$stateParams', 'Upload', function ($scope, $state, Home, $stateParams, Upload) {
...
}]).controller('ManagePopularCategoriesAddCtrl', ['$scope', '$state', 'Home', '$stateParams', 'Catalog', 'Upload', function ($scope, $state, Home, $stateParams, Catalog, Upload) {
...
//# sourceMappingURL=manage-home.controller.js.map
