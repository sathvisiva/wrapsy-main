...
.controller('AdminController', ['$scope', '$stateParams', 'Product','Order', function($scope, $stateParams, Product , Order) {
...
angular.module('bhcmartApp')
.controller('DashboardCtrl', function($scope,Auth, Modal, $state,$mdDialog,Order, Product, Catalog, User, $mdSidenav, $mdToast) {
