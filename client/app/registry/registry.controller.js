...
angular.module('bhcmartApp')
.controller('backgroundImageCtrl', ['$scope', '$stateParams', '$state', 'Registry','Upload','$uibModalInstance',
  function($scope, $stateParams, $state,  Registry,Upload, $uibModalInstance) {
