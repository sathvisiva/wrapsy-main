...
function updateCancel(req, res) {
  if (req.body._id) {
    delete req.body._id;
  }
  Order.findByIdAsync(req.params.id).then(handleEntityNotFound(res)).then(saveCancelUpdates(req.body)).then(responseWithResult(res))['catch'](handleError(res));
}
