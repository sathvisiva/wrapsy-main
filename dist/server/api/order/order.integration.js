...
describe('Order API:', function () {
  ...
  describe('GET /api/orders', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/orders').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        orders = res.body;
  ...
  describe('POST /api/orders', function () {
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).post('/api/orders').send({
        name: 'New Order',
  ...
  describe('GET /api/orders/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/orders/' + newOrder._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        order = res.body;
  ...
  describe('PUT /api/orders/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).put('/api/orders/' + newOrder._id).send({
        name: 'Updated Order',
  ...
  describe('DELETE /api/orders/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/orders/' + newOrder._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when order does not exist', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/orders/' + newOrder._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=order.integration.js.map
