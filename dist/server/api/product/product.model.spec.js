...
describe('Product', function () {
  ...
  it('should remove trailing spaces from title', function (done) {
    Product.create({ title: '  no space  ', price: 123 }, productShouldHave('title', 'no space', done));
  });

  it('should default stock to 1', function (done) {
    Product.create({ title: 'title', price: 123 }, productShouldHave('stock', 1, done));
  });
  ...
  it('should save a description', function (done) {
    Product.create({ title: 'title', price: 123, description: 'le description' }, productShouldHave('description', 'le description', done));
  });
});
